...
@section('content')
    ...
    <ul class="grid gap-3 mt-4 js-sortable" data-input-prefix="positions">
        @foreach($page->sections as $section)
            <li class="grid items-center gap-4 bg-white p-4 rounded-xl shadow-lg" style="grid-template-columns: 28px 1fr auto;" draggable="true" data-section-id="{{ $section->id }}">
                <span class="font-bold cursor-grab select-none" title="Drag to reorder">::</span>
