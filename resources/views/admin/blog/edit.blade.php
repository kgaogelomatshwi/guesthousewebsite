...
@section('content')
    ...
    <form class="form" method="post" action="{{ route('admin.blog.update', $post) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="grid-2">
            <div class="form-row">
        ...
        <div class="grid-2">
            ...
            <div class="form-row">
                ...
                <textarea name="seo_description" rows="2">{{ old('seo_description', $post->seo_description) }}</textarea>
            </div>
        </div>
        <div class="grid-2">
            <div class="form-row">
                ...
                <select name="is_published">
                    <option value="1" @selected($post->is_published)>Yes</option>
                    <option value="0" @selected(! $post->is_published)>No</option>
                </select>
            </div>
            <div class="form-row">
